# Mahjong
&nbsp;&nbsp;&nbsp;&nbsp;A GUI **Mahjong** implementation for the [UAIC](https://www.uaic.ro/en/)'s [Faculty of Computer Science Iasi](https://www.info.uaic.ro/en/presentation/)'s Python course. A **Youtube** link to a **playthrough** video can be found [here](https://www.youtube.com/watch?v=ndJU5czWqhs).
