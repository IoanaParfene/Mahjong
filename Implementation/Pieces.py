...
class Piece:
    ...
    def available(self):
        ...
        if(tile_array[self.matrix_position[0]]
                    [self.matrix_position[1]]
                    [self.matrix_position[2]][0] == False):
            available = False
        ...
        for level in range(self.matrix_position[0]+1,5):
            ...
            if (self.special_neighbour is not False):
                if (self.special_neighbour[0][0] == level and
                    ...
                    location = tile_array[self.special_neighbour[1][0]] \
                                        [self.special_neighbour[1][1]] \
                                        [self.special_neighbour[1][2]]
                    if(location[0]==True):
                        available = False
            else:
                location = tile_array[level] \
                                    [self.matrix_position[1]] \
        ...
        for column in side_neighbours:
            if(self.matrix_position[2]+column >=1 and self.matrix_position[2]+column <= 15):
                ...
                if (self.special_neighbour is not False):
                    if (self.special_neighbour[0][0] == self.matrix_position[0] and
                        ...
                        if (tile_array[self.special_neighbour[1][0]]
                                     [self.special_neighbour[1][1]]
                                     [self.special_neighbour[1][2]][0] == True):
                            total_side_neighbours += 1
                if(tile_array[self.matrix_position[0]]
                            [self.matrix_position[1]]
                            [self.matrix_position[2]+column][0] == True):
                    total_side_neighbours += 1
                    ...
                    if(current_piece==None):
                        ...
                        if(self.tile_number == pieces[tile_array[current_piece[0]]
                            ...
                            if(self.matrix_position[0] == current_piece[0]
                                ...
                                tile_array[current_piece[0]] \
                                         [current_piece[1]] \
                                         [current_piece[2]][0] = False
                                tile_array[self.matrix_position[0]] \
                                         [self.matrix_position[1]] \
                                         [self.matrix_position[2]][0] = False
                                current_piece = None
                        else:
                            ...
                            pieces[tile_array[current_piece[0]]
                                            [current_piece[1]]
                                            [current_piece[2]][1]].image = 'default'
                            current_piece = [self.matrix_position[0],
                                            self.matrix_position[1],
                                            self.matrix_position[2]]
                            self.image = 'clicked'
